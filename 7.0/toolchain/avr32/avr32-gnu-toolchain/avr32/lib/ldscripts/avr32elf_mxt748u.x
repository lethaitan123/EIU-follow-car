...
MEMORY
{
    FLASH (rxai!w) : ORIGIN = 0x80000000, LENGTH = 192K
    CPUSRAM (wxa!ri) : ORIGIN = 0x00000004, LENGTH = 0xB7FC
    USERPAGE : ORIGIN = 0x80804000, LENGTH = 256
    FACTORYPAGE : ORIGIN = 0x80804100, LENGTH = 256
    FLASHVAULT_FLASH_SIZE (r) : ORIGIN = 0x80804200, LENGTH = 8
    FLASHVAULT_RAM_SIZE (r) : ORIGIN = 0x80804208, LENGTH = 8
}
SECTIONS
{
