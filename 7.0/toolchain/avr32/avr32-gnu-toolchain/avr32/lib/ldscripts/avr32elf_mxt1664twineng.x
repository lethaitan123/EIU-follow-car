...
MEMORY
{
    ...
    CPUSRAM (wxa!ri) : ORIGIN = 0x00000004, LENGTH = 0x9FFC
    USERPAGE : ORIGIN = 0x80804000, LENGTH = 64
    FACTORYPAGE : ORIGIN = 0x80804040, LENGTH = 64
    FLASHVAULT_FLASH_SIZE (r) : ORIGIN = 0x80804080, LENGTH = 8
    FLASHVAULT_RAM_SIZE (r) : ORIGIN = 0x80804088, LENGTH = 8
}
SECTIONS
{
