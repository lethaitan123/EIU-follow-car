...
#ifndef _SAMHA0_PM_COMPONENT_
#define _SAMHA0_PM_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR PM */
/* ========================================================================== */
/** \addtogroup SAMHA0_PM Power Manager */
/*@{*/
...
#define PM_AHBMASK_MASK             _U_(0x0000003F) /**< \brief (PM_AHBMASK) MASK Register */
...
#define PM_APBBMASK_MASK            _U_(0x0000005F) /**< \brief (PM_APBBMASK) MASK Register */
...
#define PM_APBCMASK_LINCTRL         (_U_(0x1) << PM_APBCMASK_LINCTRL_Pos)
#define PM_APBCMASK_MASK            _U_(0x004FFFFF) /**< \brief (PM_APBCMASK) MASK Register */
