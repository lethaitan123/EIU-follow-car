 ...
 * \file
 *
 * \brief Header file for SAMHA0E16AB
 *
...
#ifndef _SAMHA0E16AB_
#define _SAMHA0E16AB_

/**
 * \ingroup SAMHA0_definitions
 * \addtogroup SAMHA0E16AB_definitions SAMHA0E16AB definitions
 * This file defines all structures and symbols for SAMHA0E16AB:
...
/* ************************************************************************** */
/**  CMSIS DEFINITIONS FOR SAMHA0E16AB */
/* ************************************************************************** */
/** \defgroup SAMHA0E16AB_cmsis CMSIS Definitions */
/*@{*/
...
typedef enum IRQn
{
  ...
  /******  SAMHA0E16AB-specific Interrupt Numbers *********************/
  PM_IRQn                  =  0, /**<  0 SAMHA0E16AB Power Manager (PM) */
  SYSCTRL_IRQn             =  1, /**<  1 SAMHA0E16AB System Control (SYSCTRL) */
  WDT_IRQn                 =  2, /**<  2 SAMHA0E16AB Watchdog Timer (WDT) */
  RTC_IRQn                 =  3, /**<  3 SAMHA0E16AB Real-Time Counter (RTC) */
  EIC_IRQn                 =  4, /**<  4 SAMHA0E16AB External Interrupt Controller (EIC) */
  NVMCTRL_IRQn             =  5, /**<  5 SAMHA0E16AB Non-Volatile Memory Controller (NVMCTRL) */
  DMAC_IRQn                =  6, /**<  6 SAMHA0E16AB Direct Memory Access Controller (DMAC) */
  EVSYS_IRQn               =  8, /**<  8 SAMHA0E16AB Event System Interface (EVSYS) */
  SERCOM0_IRQn             =  9, /**<  9 SAMHA0E16AB Serial Communication Interface 0 (SERCOM0) */
  SERCOM1_IRQn             = 10, /**< 10 SAMHA0E16AB Serial Communication Interface 1 (SERCOM1) */
  SERCOM2_IRQn             = 11, /**< 11 SAMHA0E16AB Serial Communication Interface 2 (SERCOM2) */
  SERCOM3_IRQn             = 12, /**< 12 SAMHA0E16AB Serial Communication Interface 3 (SERCOM3) */
  SERCOM4_IRQn             = 13, /**< 13 SAMHA0E16AB Serial Communication Interface 4 (SERCOM4) */
  SERCOM5_IRQn             = 14, /**< 14 SAMHA0E16AB Serial Communication Interface 5 (SERCOM5) */
  TCC0_IRQn                = 15, /**< 15 SAMHA0E16AB Timer Counter Control 0 (TCC0) */
  TCC1_IRQn                = 16, /**< 16 SAMHA0E16AB Timer Counter Control 1 (TCC1) */
  TCC2_IRQn                = 17, /**< 17 SAMHA0E16AB Timer Counter Control 2 (TCC2) */
  TC3_IRQn                 = 18, /**< 18 SAMHA0E16AB Basic Timer Counter 3 (TC3) */
  TC4_IRQn                 = 19, /**< 19 SAMHA0E16AB Basic Timer Counter 4 (TC4) */
  TC5_IRQn                 = 20, /**< 20 SAMHA0E16AB Basic Timer Counter 5 (TC5) */
  TC6_IRQn                 = 21, /**< 21 SAMHA0E16AB Basic Timer Counter 6 (TC6) */
  TC7_IRQn                 = 22, /**< 22 SAMHA0E16AB Basic Timer Counter 7 (TC7) */
  ADC_IRQn                 = 23, /**< 23 SAMHA0E16AB Analog Digital Converter (ADC) */
  AC_IRQn                  = 24, /**< 24 SAMHA0E16AB Analog Comparators  (AC) */
  DAC_IRQn                 = 25, /**< 25 SAMHA0E16AB Digital Analog Converter (DAC) */
...
/* ************************************************************************** */
/**  SOFTWARE PERIPHERAL API DEFINITION FOR SAMHA0E16AB */
/* ************************************************************************** */
/** \defgroup SAMHA0E16AB_api Peripheral Software API */
/*@{*/
...
/* ************************************************************************** */
/**  REGISTERS ACCESS DEFINITIONS FOR SAMHA0E16AB */
/* ************************************************************************** */
/** \defgroup SAMHA0E16AB_reg Registers Access Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PERIPHERAL ID DEFINITIONS FOR SAMHA0E16AB */
/* ************************************************************************** */
/** \defgroup SAMHA0E16AB_id Peripheral Ids Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  BASE ADDRESS DEFINITIONS FOR SAMHA0E16AB */
/* ************************************************************************** */
/** \defgroup SAMHA0E16AB_base Peripheral Base Address Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PORT DEFINITIONS FOR SAMHA0E16AB */
/* ************************************************************************** */
/** \defgroup SAMHA0E16AB_port PORT Definitions */
/*@{*/

#include "pio/samha0e16ab.h"
/*@}*/

/* ************************************************************************** */
/**  MEMORY MAPPING DEFINITIONS FOR SAMHA0E16AB */
/* ************************************************************************** */
...
#define DSU_DID_RESETVALUE    _UL_(0x1001158F)
...
/* ************************************************************************** */
/**  ELECTRICAL DEFINITIONS FOR SAMHA0E16AB */
/* ************************************************************************** */
