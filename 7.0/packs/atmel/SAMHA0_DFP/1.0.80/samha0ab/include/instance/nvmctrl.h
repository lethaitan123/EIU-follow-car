...
#ifndef _SAMHA0_NVMCTRL_INSTANCE_
#define _SAMHA0_NVMCTRL_INSTANCE_
...
#define NVMCTRL_RWWEE_PAGES         32       // Number of pages in the RWW EEPROM area
#define NVMCTRL_RWW_EEPROM_ADDR     0x00400000 // Start address of the RWW EEPROM area

#endif /* _SAMHA0_NVMCTRL_INSTANCE_ */
