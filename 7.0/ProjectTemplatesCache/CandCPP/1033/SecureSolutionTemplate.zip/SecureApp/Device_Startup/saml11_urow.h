...
#define UROW_NONSECA_MCLK			0x0		/* 0x0 = MCLK is secured ; MCLK is Non-secured */
...
#define UROW_NONSECA_GCLK			0x0		/* 0x0 = GCLK is secured ; GCLK is Non-secured */
...
#define UROW_NONSECC_SERCOM0		0x0		/* 0x0 = SERCOM0 is secured ; SERCOM0 is Non-secured */
...
#define UROW_NONSECC_TC1			0x0		/* 0x0 = TC1 is secured ; TC1 is Non-secured */
